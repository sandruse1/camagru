...
$query = array(
    'createCom' => 'CREATE TABLE IF NOT EXISTS `coment_g` (id INT UNSIGNED PRIMARY KEY AUTO_INCREMENT NOT NULL, users_comented VARCHAR(50) NOT NULL, coments VARCHAR(1000) NOT NULL, img_src VARCHAR(20))',
